...
from HandTracking import lmList1, handType1, length
from ZoomGestureImage import tipOfFirstFinger
...
while True:
    ...
    if hands:
        ...
        if len(hands) == 2:
            ...
            tipOfFirstFinger2 = lmList1[4][0:2]
            tipOfSecondFinger2 = lmList1[8][0:2]
